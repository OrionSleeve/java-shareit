...
public interface BookingService {
    ...
    List<BookingDtoResp> getBookingByBookerId(long userId, String state, int from, int size);

    List<BookingDtoResp> getBookingByItemOwner(long userId, String state, int from, int size);
}
